...
namespace ServicesOrientedAnalyzer.Test
{
        ...
        where TCodeFix : CodeFixProvider, new()
    {
        ...
        {
            return CSharpCodeFixVerifier<TAnalyzer, TCodeFix, TestVerifier>.Diagnostic();
        }

        /// <inheritdoc cref="CodeFixVerifier{TAnalyzer, TCodeFix, TTest, TVerifier}.Diagnostic(string)" />
        public static DiagnosticResult Diagnostic(string diagnosticId)
        {
            return CSharpCodeFixVerifier<TAnalyzer, TCodeFix, TestVerifier>.Diagnostic(diagnosticId);
        }

        /// <inheritdoc cref="CodeFixVerifier{TAnalyzer, TCodeFix, TTest, TVerifier}.Diagnostic(DiagnosticDescriptor)" />
        public static DiagnosticResult Diagnostic(DiagnosticDescriptor descriptor)
        {
            return CSharpCodeFixVerifier<TAnalyzer, TCodeFix, TestVerifier>.Diagnostic(descriptor);
        }
